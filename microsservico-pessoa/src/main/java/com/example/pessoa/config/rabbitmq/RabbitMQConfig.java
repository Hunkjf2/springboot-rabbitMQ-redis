package com.example.pessoa.config.rabbitmq;
...
public class RabbitMQConfig {
    ...
    /**
     * Cria um RabbitTemplate para envio de mensagens assíncronas.
     *
    ...
    // Sincrona - para comunicação com Serasa
    /**
    ...
    /**
     * Configuração do listener container para consumir mensagens de resposta.
